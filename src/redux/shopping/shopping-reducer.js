...
const shopReducer = (state = INITIAL_STATE, action) =>{
    switch(action.type){
        case actionTypes.GET_PRODUCTS:
            return {...state, products: action.payload, filteredProducts: action.payload, cart: state.cart}
        case actionTypes.FILTER_PRODUCTS:
            return {...state, filteredProducts: action.payload.product, size: action.payload.size}
